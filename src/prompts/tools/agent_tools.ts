...
export const DEFAULT_AGENT_TOOLS = [
    ...
    {
        id: "execute-plan",
        name: { zh: "执行规划", en: null },
        prompt: { zh: "请读取以下规划文件，严格按照规划内容编写章节正文并写入对应的章节文件中。\n\n规划文件：@{plan文件路径}\n\n若规划文件中包含 chapter 字段，将正文写入该路径；否则根据规划标题推断章节文件路径。若存在风格指南（WRITER.md），章节风格必须严格遵守其中的要求。", en: null }
    },
    {
        id: "update-memory",
